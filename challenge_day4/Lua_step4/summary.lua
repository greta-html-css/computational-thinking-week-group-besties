...
local lines = {}
for line in io.lines("../Julia_step3/data4.csv") do
...
for _, line in ipairs(lines) do
    ...
    local valid_keys = {super=true, good=true, middle=true, low=true}
    for _, skill in ipairs({tech, soft, bus, creative, academic}) do
        if valid_keys[skill] then
            summary[skill] = summary[skill] + 1
        end
    end
